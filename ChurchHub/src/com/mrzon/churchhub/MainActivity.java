...
public class MainActivity extends RoboActivity {
    ...
    @InjectView(R.id.main_nearby_button)
    
    /**
     * Button to open nearest church Activity
     */
    private Button nearest;
    @InjectView(R.id.main_browse_button)

    /**
     * Button to Open CHDialog.BrowseDialogFragment
     */
...
//    private Button stats;
     ...
     */
    @InjectView(R.id.main_history_button)
    private Button recent;
    
    /**
     * Button to open CHDialog.LoginDialogFragment
     */
    @InjectView(R.id.login)
    private Button login;
    
    /**
     * Button to open CHDialog.SignUpDialogFragment
     */
    @InjectView(R.id.signup)
    private Button signup;
    
    /**
     * TextView to display "login as" string
     */
    @InjectView(R.id.loginAsTV)
    private TextView loginAsLabel;
    
    /**
     * TextView to display name of the logged in user
     */
